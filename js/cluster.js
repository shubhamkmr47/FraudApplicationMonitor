function plotCluster() {
    ...
    var width = x / 2, // svg width
        height = y - 20, // svg height
        dr = 7, // default point radius
    ...
    function init() {
        ...
        node.enter().append("circle")
            ...
            .attr("r", function(d) {
                return d.size ? Math.min(30, d.size + dr) : Math.min(30, dr + 1);
            })
            .attr("cx", function(d) {
                return d.x;
            })
        ...
        force.on("tick", function() {
            ...
            node.attr("cx", function(d) {
                    return d.x = Math.max(dr, Math.min(width - dr, d.x));
                })
                .attr("cy", function(d) {
                    return d.y = Math.max(dr, Math.min(height - dr, d.y));
                });
